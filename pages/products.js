...
const Products = () => (
  <Page>
    <Heading>You created a new page called Products</Heading>
    <p>You can visit this page by appending "/Products" to your URL</p>
    <p>You can edit this page in "/pages/Products</p>
